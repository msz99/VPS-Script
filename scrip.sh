...
"
# script
wget -O /usr/local/bin/menu "https://raw.githubusercontent.com/msz99/VPS-Script/master/menu"
wget -O /usr/local/bin/m "https://raw.githubusercontent.com/msz99/VPS-Script/master/menu"
wget -O /usr/local/bin/autokill "https://raw.githubusercontent.com/msz99/VPS-Script/master/autokill"
wget -O /usr/local/bin/user-generate "https://raw.githubusercontent.com/msz99/VPS-Script/master/user-generate"
wget -O /usr/local/bin/speedtest "https://raw.githubusercontent.com/msz99/VPS-Script/master/speedtest"
wget -O /usr/local/bin/user-lock "https://raw.githubusercontent.com/msz99/VPS-Script/master/user-lock"
wget -O /usr/local/bin/user-unlock "https://raw.githubusercontent.com/msz99/VPS-Script/master/user-unlock"
wget -O /usr/local/bin/auto-reboot "https://raw.githubusercontent.com/msz99/VPS-Script/master/auto-reboot"
wget -O /usr/local/bin/user-password "https://raw.githubusercontent.com/msz99/VPS-Script/master/user-password"
wget -O /usr/local/bin/trial "https://raw.githubusercontent.com/msz99/VPS-Script/master/trial"
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/msz99/VPS-Script/master/common-password"
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/msz99/VPS-Script/master/banner"
# dropbear
apt-get -y install dropbear
wget -O /etc/default/dropbear "https://raw.githubusercontent.com/msz99/VPS-Script/master/dropbear"
echo "/bin/false" >> /etc/shells
echo "/usr/sbin/nologin" >> /etc/shells
# squid3
apt-get -y install squid3
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/msz99/VPS-Script/master/squid.conf"
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/msz99/VPS-Script/master/squid.conf"
sed -i "s/ipserver/$myip/g" /etc/squid3/squid.conf
sed -i "s/ipserver/$myip/g" /etc/squid/squid.conf
# openvpn
apt-get -y install openvpn
cd /etc/openvpn/
wget https://raw.githubusercontent.com/msz99/VPS-Script/master/openvpn.tar;tar xf openvpn.tar;rm openvpn.tar
wget -O /etc/rc.local "https://raw.githubusercontent.com/msz99/VPS-Script/master/rc.local"
chmod +x /etc/rc.local
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/msz99/VPS-Script/master/iptables.up.rules"
...
wget https://raw.githubusercontent.com/msz99/VPS-Script/master/badvpn-1.999.128.tar.bz2 -o /dev/null
...
wget -P /etc/stunnel/ "https://raw.githubusercontent.com/msz99/VPS-Script/master/stunnel.conf"
openssl genrsa -out key.pem 2048
wget -P /etc/stunnel/ "https://raw.githubusercontent.com/msz99/VPS-Script/master/stunnel.pem"
sed -i 's/ENABLED=0/ENABLED=1/g' /etc/default/stunnel4
# nginx
apt-get -y install nginx php5-fpm php5-cli libexpat1-dev libxml-parser-perl
rm /etc/nginx/sites-enabled/default
rm /etc/nginx/sites-available/default
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/msz99/VPS-Script/master/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>SETUP BY MSZ PM TELEGRAM @MSZ99</pre>" > /home/vps/public_html/index.php
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/msz99/VPS-Script/master/vps.conf"
...
# etc
wget -O /var/www/html/client.ovpn "https://raw.githubusercontent.com/msz99/VPS-Script/master/client.ovpn"
wget -O /etc/motd "https://raw.githubusercontent.com/msz99/VPS-Script/master/motd"
sed -i 's/AcceptEnv/#AcceptEnv/g' /etc/ssh/sshd_config
...
useradd -m -g users -s /bin/bash MSZ
echo "MSZ:MSZ99" | chpasswd
...
echo "MSZ Cleartext-Password := MSZ99" > /etc/freeradius/users
# Lock Dropbear Expired ID
wget -O /usr/local/bin/lockidexp.sh "https://raw.githubusercontent.com/msz99/VPS-Script/master/lockidexp.sh"
...
rm mycron
# BlockTorrent
wget -O /usr/local/bin/BlockTorrentEveryReboot "https://raw.githubusercontent.com/msz99/VPS-Script/master/BlockTorrentEveryReboot"
